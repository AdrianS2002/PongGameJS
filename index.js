...
const paddle1Colour = "red";
const paddle2Colour = "green";
const centerLine = "white";
...
function changeDirection(event){
    ...
    switch (keyPressed){
        ...
        case(paddle1Down):
            ...
            break;
        case(paddle1Right):
            if(paddle1.x < gameWidth/2 - 2*paddle1.width){
        ...
        case(paddle2Left):
            if(paddle2.x > gameWidth/2+ 2*paddle2.width){
                paddle2.x -= paddleSpeed;
            }
            break;
    }
